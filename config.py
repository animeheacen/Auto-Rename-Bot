...
class Config(object):
    ...
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "7823325255:AAF7D_bUoVNSX1mY4vJdrTmntQKtgFC_fcw") 

    # database config
    DB_NAME = os.environ.get("DB_NAME","Yato")     
    DB_URL  = os.environ.get("DB_URL","mongodb+srv://suihioobb:NSIF6uo4u40vLZXE@cluster0.s2utuuh.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
    PORT = os.environ.get("PORT", "8080")
 
    # other configs
    BOT_UPTIME  = time.time()
    START_PIC   = os.environ.get("START_PIC", "https://graph.org/file/29a3acbbab9de5f45a5fe.jpg")
    ADMIN       = [int(admin) if id_pattern.search(admin) else admin for admin in os.environ.get('ADMIN', '6853851676').split()]
    FORCE_SUB_CHANNELS = os.environ.get('FORCE_SUB_CHANNELS', 'codeflix_bots').split(',')
    LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1002641554526"))
    DUMP_CHANNEL = int(os.environ.get("DUMP_CHANNEL", "-1002529799599"))
